...
path_write = "\\data\\char_pre_processed_v112222"
...
for root, dirs, files in os.walk(path):
	for file_name in files:
		if(file_name.endswith(".bmp")):
			...
			print(img.shape[0] > 30 and img.shape[1] > 30 and str_folder != 'n1')
			if True:
			...
			print(img.shape[0] > 20 and img.shape[1] > 15 and str_folder == 'n1')
